...
def ask_often_service_fun():
    ...
    {"key":"1", "value": "ヘアサロン"},
    {"key":"2", "value": "ネイルサロン"},
    {"key":"3", "value": "アイラッシュサロン"},
    {"key":"4", "value": "リラクゼーションサロン"},
    {"key":"5", "value": "エステサロン"},
    ]   
...
def find_salon_fun():
    ...
    salon2_staff_list = [
        {
            "id": 58,
            "name": "Rajesh Jain",
            "image": "https://web.jtsboard.com/uploads/note_image/original/file_15441827970.jpg",
            "service": "フェイシャル"
        },

        {
            "id": 131,
            "name": "asfasf",
            "image": "https://web.jtsboard.com/uploads/note_image/original/0f5c6773d39d52e7c167a3783623a91b.jpg",
            "service": "アイラッシュ"
        },
    ]
    ...
    salon2_image_list = [
        "https://api.jtsboard.com/uploads/my_shop/original/d47e653ac53f64669fbafc9dbd685eb1.jpg",
        "https://api.jtsboard.com/uploads/my_shop/original/f0e21a7e931b3c7ce0483a08cf84476a.jpg",
        "https://api.jtsboard.com/uploads/my_shop/original/f724ccc696e69c3a60d349d1fc219458.jpg",
    ]
...
def chat():
    ...
    while True:
        ...
        if STATE == "CONFIRM_SPECIFIC_SALON":
            out_msg_1,out_msg_2,option_list_1,option_list_2 = confirm_specific_salon_fun()
        ...
        if STATE == "ASK_PHONE":
            out_msg_1,out_msg_2 = ask_phone(cust_responses)
            STATE = "PHONE_ASKED"
            return_dict["status"] = "success"
            return_dict["error_msg"] = ""
            return_dict["chat"] = return_list_of_dicts
        ...
        if STATE == "ASK_EMAIL":
            out_msg = ask_email_fun(cust_responses)  
            STATE = "EMAIL_ASKED"
